...
public class MediaStoreTableEx extends MediaStoreTable implements TableExProxy<MediaStore, MediaStoreTable> {
    public static final MediaStoreTableEx $ = new MediaStoreTableEx(MediaStoreTable.$, (String)null);

    public MediaStoreTableEx() {
        super();
    }

    public MediaStoreTableEx(AbstractTypedTable.DelayedOperation<MediaStore> delayedOperation) {
        super(delayedOperation);
    }

    public MediaStoreTableEx(TableImplementor<MediaStore> table) {
        super(table);
    }

    protected MediaStoreTableEx(MediaStoreTable base, String joinDisabledReason) {
        super(base, joinDisabledReason);
    }

    protected MediaStoreTableEx(MediaStoreTable base, BaseTableOwner baseTableOwner) {
    ...
    @Override
    public MediaStoreTableEx __disableJoin(String reason) {
        return new MediaStoreTableEx(this, reason);
    }

    @Override
    public MediaStoreTableEx __baseTableOwner(BaseTableOwner baseTableOwner) {
        return new MediaStoreTableEx(this, baseTableOwner);
    }

    public <TT extends Table<?>, WJ extends WeakJoin<MediaStoreTable, TT>> TT weakJoin(
    ...
    public <TT extends Table<?>> TT weakJoin(Class<TT> targetTableType,
            WeakJoin<MediaStoreTable, TT> weakJoinLambda) {
