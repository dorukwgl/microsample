...
public class ProductServersTableEx extends ProductServersTable implements TableExProxy<ProductServers, ProductServersTable> {
    public static final ProductServersTableEx $ = new ProductServersTableEx(ProductServersTable.$, (String)null);

    public ProductServersTableEx() {
        super();
    }
    ...
    public ProductServersTableEx(TableImplementor<ProductServers> table) {
        super(table);
    }

    protected ProductServersTableEx(ProductServersTable base, String joinDisabledReason) {
        super(base, joinDisabledReason);
    }

    protected ProductServersTableEx(ProductServersTable base, BaseTableOwner baseTableOwner) {
    ...
    @Override
    public ProductServersTableEx __disableJoin(String reason) {
        return new ProductServersTableEx(this, reason);
    }

    @Override
    public ProductServersTableEx __baseTableOwner(BaseTableOwner baseTableOwner) {
        return new ProductServersTableEx(this, baseTableOwner);
    }

    public <TT extends Table<?>, WJ extends WeakJoin<ProductServersTable, TT>> TT weakJoin(
    ...
    public <TT extends Table<?>> TT weakJoin(Class<TT> targetTableType,
            WeakJoin<ProductServersTable, TT> weakJoinLambda) {
