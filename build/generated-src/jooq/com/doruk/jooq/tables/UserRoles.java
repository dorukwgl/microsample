...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    /**
     * The reference instance of <code>kendra.user_roles</code>
     */
    ...
    /**
     * The column <code>kendra.user_roles.user_id</code>.
     */
    public final TableField<UserRolesRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>kendra.user_roles.name</code>.
     */
    public final TableField<UserRolesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(100).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>kendra.user_roles</code> table reference
     */
    ...
    /**
     * Create a <code>kendra.user_roles</code> table reference
     */
    public UserRoles() {
    ...
    public List<ForeignKey<UserRolesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_ROLES__USER_ROLES_NAME_FKEY, Keys.USER_ROLES__USER_ROLES_USER_ID_FKEY);
    }
    ...
    public RolesPath roles() {
        if (_roles == null)
            _roles = new RolesPath(this, Keys.USER_ROLES__USER_ROLES_NAME_FKEY, null);
    ...
    public UserRoles where(Condition condition) {
        return new UserRoles(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public UserRoles whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public UserRoles whereNotExists(TableLike<?> select) {
