...
public class Templates {
    ...
    public static String organizationInviteTemplate() {
        return """
                    <h2>You're Invited to Join an Organization</h2>
                    <p>Hello,</p>
                    <p>You have been invited to join an organization on the Kendra platform.</p>
                    <p>To join the organization, please visit the link below:</p>
                    <p><a href="{{url}}">View Organization</a></p>
                    <p>If you don't have an account yet, you'll need to register first before joining.</p>
                    <p>If you didn't expect this invitation, please ignore this email.</p>
                    <p>Best regards,<br>The Kendra Team</p>
                    """;
    }
}