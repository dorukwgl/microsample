...
public class BrevoMailService implements MailService {
    ...
    @Override
    public void sendMail(MailParams mailParams, TemplateType type) {
        Pair<String, String> template = switch (type) {
            ...
            case ORGANIZATION_INVITE -> new Pair<>("Organization Invitation", Templates.organizationInviteTemplate());
        ...
        var request = new BrevoMailRequest(
                ...
                Map.of(
                        ...
                        "url", type == TemplateType.PASSWORD_RESET || type == TemplateType.ORGANIZATION_INVITE ?
                                mailParams.tempUrl() : ""
                )
        );
